...
public class ListPreferenceMultiSelect extends ListPreference {
	...
	public ListPreferenceMultiSelect(Context context, AttributeSet attrs) {
		...
		// checkAllKey =
		// a.getString(R.styleable.ListPreferenceMultiSelect_checkAll);
		// String s =
		// a.getString(R.styleable.ListPreferenceMultiSelect_separator);
		/*
		 * String s = null; if( s != null ) { separator = s; } else { separator
		 * = DEFAULT_SEPARATOR; }
		 */
