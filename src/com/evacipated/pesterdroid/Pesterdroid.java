...
public class Pesterdroid extends SherlockFragmentActivity implements ServiceConnection {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Tab tab = actionbar.newTab().setText("#General_Chat").setIcon(R.drawable.chummy);
		mTabsAdapter.addTab(tab, ConversationFragment.class, null);

		tab = actionbar.newTab().setText("canLover");
		mTabsAdapter.addTab(tab, ConversationFragment.class, null);
	}
	...
	public static class MyTabListener extends FragmentPagerAdapter implements ActionBar.TabListener, ViewPager.OnPageChangeListener {
