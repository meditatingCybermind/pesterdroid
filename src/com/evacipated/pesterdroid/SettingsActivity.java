...
public class SettingsActivity extends SherlockPreferenceActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		alertbuilder.setTitle("Low Bandwith Mode").setMessage("Low Bandwidth Mode drastically reduces the amount of data used, thus increasing battery life at the cost of being unable to see when chums are online.").setPositiveButton("OK", null);
